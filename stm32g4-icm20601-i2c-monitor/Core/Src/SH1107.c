...
extern I2C_HandleTypeDef hi2c2; // main.c'deki donanım tanımını çağırıyoruz
uint8_t screen_buffer[2048];    // 128x128 / 8 = 2048 Byte RAM tamponu

// Ekrana komut gönderme
void SH1107_WriteCmd(uint8_t cmd) {
    HAL_I2C_Mem_Write(&hi2c2, SH1107_I2C_ADDR, SH1107_CMD, I2C_MEMADD_SIZE_8BIT, &cmd, 1, HAL_MAX_DELAY);
}
...
void SH1107_Update(void) {
    for (uint8_t page = 0; page < 16; page++) {
        ...
        HAL_I2C_Mem_Write(&hi2c2, SH1107_I2C_ADDR, SH1107_DATA, I2C_MEMADD_SIZE_8BIT, &screen_buffer[page * 128], 128, HAL_MAX_DELAY);
    }
}
